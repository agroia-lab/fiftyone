#!/usr/bin/env python3
"""
Process Lo Castillo ground camera dataset with CLIP embeddings.
Total expected: 1,215 JPG + 306 HEIC = 1,521 images
"""
...
# Configuration
DATASET_NAME = "lo_castillo"
SOURCE_PATH = "/home/malezainia1/dev/INIA_DeepLearning_Ubuntu_mod_lleon/data/campo5_enero26/Lo Castillo/Celular"
OUTPUT_DIR = Path("/home/malezainia1/dev/voxel51/fiftyone/sessions/2026-01-14/research/datasets/lo_castillo/data")
...
def main():
    print("="*60)
    print("Processing Lo Castillo Ground Camera (JPG + HEIC)")
    print("="*60)
    ...
    for i, sample in enumerate(dataset):
        ...
        # Get file size
        size_bytes = os.path.getsize(sample.filepath) if os.path.exists(sample.filepath) else 0
    ...
    csv_path = OUTPUT_DIR / "lo_castillo_data.csv"
