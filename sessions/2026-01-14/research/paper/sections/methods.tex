...
Five agricultural field sites in central Chile were surveyed:
...
Lo Castillo & -34.1627, -70.6884 & Tomato & January 2026 \\
\bottomrule
\end{tabular}
\end{table}
...
\finding{Ground camera datasets are significantly larger (33--1,521 images) than drone datasets (97--111 images), reflecting the different data collection workflows---walking through fields vs. programmed flight paths}
...
\begin{itemize}
    \item Efficient handling of large image datasets (4,870 images across all sites)
